                ...
                <div class="card-body text-dark">
                  <form>
                    <div class="form-group">
                      <label for="email">Phone number or login</label>
                      <input type="email" class="form-control" id="email" placeholder="Enter phone number or login">
                    </div>
                    <div class="form-group">
                      <label for="password">Password or cart number</label>
                      <input type="password" class="form-control" id="password" placeholder="Enter password or cart number">
                    </div>
